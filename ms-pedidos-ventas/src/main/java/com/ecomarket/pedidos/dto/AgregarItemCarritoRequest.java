...
public class AgregarItemCarritoRequest {
    ...
    @Schema(description = "Cantidad a agregar", example = "2", minimum = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Stock disponible al momento de agregar (para validacion)", example = "15")
