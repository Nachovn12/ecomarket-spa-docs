...
|---|---|:---:|:---:|:---:|
| **api-gateway** | Ignacio Valeria | 4 tests | N/A (Smoke & Route Tests) | PASSED |
| **ms-usuarios-identidad** | Benjamín Flores | 92 tests | **100%** | PASSED |
| **ms-catalogo** | Benjamín Espinoza | 75 tests | **100%** | PASSED |
| **ms-inventario-abastecimiento** | Benjamín Palma | 119 tests | **100%** | PASSED |
| **ms-pedidos-ventas** | Ignacio Valeria | 174 tests | **100%** | PASSED |
| **ms-logistica-envios** | Benjamín Espinoza | 98 tests | **100%** | PASSED |
| **ms-administracion-soporte** | Benjamín Flores | 85 tests | **100%** | PASSED |
| **ms-reportes** | Benjamín Palma | 70 tests | **100%** | PASSED |
