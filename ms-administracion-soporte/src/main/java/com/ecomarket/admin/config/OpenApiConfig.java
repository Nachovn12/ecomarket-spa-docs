...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("MS Administración y Soporte API")
                        .version("1.0.0")
                        .description("API del microservicio de Administración y Soporte. Gestiona tiendas, tickets, métricas, alertas y respaldos.")
                        .contact(new Contact()
