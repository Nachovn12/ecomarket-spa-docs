package com.ecomarket.usuarios.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("MS Usuarios e Identidad API")
                        .version("1.0.0")
                        .description("API del microservicio de Usuarios e Identidad. Gestiona registro, login, autenticación, roles y permisos.")
                        .contact(new Contact()
